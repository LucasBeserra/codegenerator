...
class FormularioTampaFiltro:
    def __init__(self, parent, app):
        ...
        # Título
        ttk.Label(frame, text="Gerador de Código - Tampa Filtro", 
        ...
        ttk.Label(frame, text="Perfil:", font=('Arial', 10, 'bold')).grid(
            row=row, column=0, sticky=tk.W, pady=5)
        self.perfil_entry = ttk.Entry(frame, width=50)
        self.perfil_entry.grid(row=row, column=1, pady=5, padx=5)
        ttk.Label(frame, text="(ex: Quadrada, Redonda, etc)", font=('Arial', 8), 
    ...
    def gerar_codigo(self):
        ...
        try:
            # Importa e instancia o modelo TampaFiltro
